...
class QGE():
    ...
    def epsilon(self):
        ...
        if self.epsilon_option == 'a':
            ...
            rate = 12/10
            return max(0.1, 0.9 * (0.1/0.9) ** (self.episode ** rate / 6000 ** rate))
    ...
    def csv_header(self):
        ...
        self.train_ini_time = datetime.datetime.now()
        self.train_data.write(
            'episode', 'epsilon', 'steps', 'dones',
            'truncs', 'total_seconds', 'q_table_zeros',
        )
        self.csv_write(0, 0, 0, 0, 0, 0)
    ...
    def csv_write(
        ...
        total_seconds = (
            (datetime.datetime.now()-self.train_ini_time).total_seconds()
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "     epsilon=max(0.1, 0.9*(0.1/0.9)^(episode^rate/6000^rate))\n"
            "     default rate 12 (/10)\n"
